...
\begin{document}
    ...
    \begin{definition}[Recherche coopérative de chemin]
        Une instance d'un problème de recherche coopérative de chemin, ou CPF, sera déclarée comme le quadruplé $\Sigma = \langle G, A, \alpha_0, \alpha^+ \rangle$;
    ...
    \begin{proof}
        ...
        De plus, par construction de $TEG^\tau(G) = \langle V', E' \rangle$, pour toute arête orientée $\langle v^t, u^{t+1} \rangle \in \pi_i$ 
    ...
    \begin{definition}[Reduction de l'espace de recherche d'un agent $MDD_i^\tau$]
        Soit le problème CPF suivant $\Sigma = \langle G, A, \alpha_0, \alpha^+ \rangle$ avec $G = \langle V, E \rangle$, $A = \{a_1, a_2, \ldots a_m\}$.
    ...
    \begin{proposition}
        S'il existe une solution de durée $\tau$ pour un problème CPF $\Sigma = \langle G, A, \alpha_0, \alpha^+ \rangle$,
    ...
    \begin{definition}[Encodage DIRECT $F(\Sigma, \tau)$]
        ...
        la durée maximale, l'expansion de ce graphe, et sa réduction pour chaque agent $a_i \in A$ nous donne $MDD^\tau_i(G) = \langle V', E' \rangle$.
